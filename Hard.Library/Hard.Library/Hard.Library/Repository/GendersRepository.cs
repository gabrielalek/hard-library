    ...
    public class GendersRepository : IGendersRepository
    {
        ...
        public Gender Create(Gender gender)
        {
            ...
            if (string.IsNullOrEmpty(gender.Name))
                throw new ArgumentNullException(nameof(Gender.Name), "O nome do livro é obrigatório");
        ...
        public IEnumerable<Gender> GetAll() => _context.Genders.Include(g => g.Books).ToList();
